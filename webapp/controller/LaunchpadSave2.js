sap.ui.define([
	...
	return BaseController.extend("authenticator.controller.Launchpad", {
		...
		// 		}
		// 		else if (event.data === "onCreateEquipments" || event.data === "onCreateDrivers") {
		...
		// 			if (event.data === "onCreateEquipments") {
		...
		// 				that.onRouteMatched();
		// 			}
		// 			else if (event.data === "onCreateDrivers") {
		// 				sessionStorage.setItem("create", true);
		...
		// 					}
		// 					else if (oTheme.getSelectedKey() != sessionStorage.getItem("selectedTheme")) {
